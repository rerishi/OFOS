...
public class UserListenerImplementationClass extends UserBaseClass implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			WebDriverUtility.getScreenshot(sdriver,FScript);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void onStart(ITestContext context) {
		...
		report.setSystemInfo("url", "http://rmgtestingserver/domain/Online_Food_Ordering_System/login.php");
